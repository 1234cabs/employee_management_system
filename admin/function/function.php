...
if(isset($_POST['create'])){
    ...
    $stmt = $conn->prepare("INSERT INTO users (fullname,email,contact,username,position,role,password) VALUES(?,?,?,?,?,?,?)");
...
$stmt->execute();
$_SESSION['success'] = "This Record Deleted Successfully!";
header("Location: ../admin.php");
exit;
?>